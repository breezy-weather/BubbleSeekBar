**Project archived, we replaced BubbleSeekBar with official Google lib for [Slider](https://github.com/material-components/material-components-android/blob/master/docs/components/Slider.md).**
